    ...
    >
      ...
      >
        <Image
          ...
          alt={t('home.logoAlt') || "Logo ACTQ, association culturelle turque en Bretagne"}
          width={140}
          height={140}
        ...
        <div className="w-full space-y-5">
          ...
          <button
            ...
            aria-label={t(`home.guest.signup`)}
          >
            {t(`home.guest.signup`)}
          </button>
          ...
          <button
            ...
            aria-label={t(`home.guest.forgot`)}
          >
            {t(`home.guest.forgot`)}
          </button>
        </div>
